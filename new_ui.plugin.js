	...
	rabbitHoleSettings.innerHTML = 
			...
			<div id="rabbit-settings-entries" class="collapsible-content" style="display: block;margin-top:15px;">
				<table><tbody>
					...
					<tr class="pl-5"><td><label for="loraAlphaStep_input">LORA Strength Step Size:</label></td><td> <input id="loraAlphaStep_input" name="loraAlphaStep_input" size="10" value="`+settings.loraAlphaStep+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					<tr class="pl-5"><td><label for="loraAlphaMid_input">LORA Strength Midpoint:</label></td><td> <input id="loraAlphaMid_input" name="loraAlphaMid_input" size="10" value="`+settings.loraAlphaMid+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					...
					<tr class="pl-5"><td><label for="scaleStep_input">Guidance Scale Step Size:</label></td><td> <input id="scaleStep_input" name="scaleStep_input" size="10" value="`+settings.scaleStep+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					<tr class="pl-5"><td><label for="scaleMid_input">Guidance Scale Midpoint:</label></td><td> <input id="scaleMid_input" name="scaleMid_input" size="10" value="`+settings.scaleMid+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					...
					<tr class="pl-5 img2imgOnly"><td><label for="promptStrengthStep_input">Prompt Strength Step Size:</label></td><td> <input id="promptStrengthStep_input" name="promptStrengthStep_input" size="10" value="`+settings.promptStrengthStep+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					<tr class="pl-5 img2imgOnly"><td><label for="promptStrengthMid_input">Prompt Strength Midpoint:</label></td><td> <input id="promptStrengthMid_input" name="promptStrengthMid_input" size="10" value="`+settings.promptStrengthMid+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					...
					<tr class="pl-5"><td><label for="hyperStrengthStep_input">Hyper Strength Step Size:</label></td><td> <input id="hyperStrengthStep_input" name="hyperStrengthStep_input" size="10" value="`+settings.hyperStrengthStep+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
					<tr class="pl-5"><td><label for="hyperStrengthMid_input">Hyper Strength Midpoint:</label></td><td> <input id="hyperStrengthMid_input" name="hyperStrengthMid_input" size="10" value="`+settings.hyperStrengthMid+`" onkeypress="preventNonNumericalInput(event)" onchange="setSettings()"></td></tr>
